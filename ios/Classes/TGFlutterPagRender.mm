...
- (void)setVideoEnabled:(BOOL)videoEnabled{
    [_player setVideoEnabled:videoEnabled];
}

- (void)setUseDiskCache:(BOOL)useDiskCache{
    [_player setUseDiskCache:useDiskCache];
}

- (void)setCacheScale:(float)cacheScale{
    [_player setCacheScale:cacheScale];
}
